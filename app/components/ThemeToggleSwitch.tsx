  ...
  return (
    <div>
      <button
        ...
        className={`hidden md:flex items-center justify-center relative px-3 w-16 h-8 rounded-full transition-all duration-700 ${
          isDark
      ...
      >
        ...
        >
          {isDark ? (
            <Moon
              strokeWidth={1.5}
              className="nav-element w-6 h-6 text-gray-700"
            />
          ) : (
            <Sun
              strokeWidth={1.5}
      ...
      >
        {isDark ? (
          ...
          <Sun strokeWidth={1.5} className="w-5 h-5 text-gray-700" />
        )}
      </button>
    </div>
  );
